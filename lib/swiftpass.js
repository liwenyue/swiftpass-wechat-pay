...
Swiftpass.prototype.unifiedOrder = function(params, callback) {
  var requiredData = ['body', 'out_trade_no', 'total_fee', 'mch_create_ip', 'mch_id', 'service','sub_openid'];
  // if (params.service == 'pay.weixin.jspay') {
  //   requiredData.push('sub_openid');
  // }
...
Swiftpass.prototype.validate = function(xml, callback) {
  ...
  xml2js.parseString(xml, {
    ...
    } else if (self.subAppId !== data.sub_appid) {
      error = new Error();
      error.name = 'InvalidSubAppId';
